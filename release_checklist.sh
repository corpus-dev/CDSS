...
check "mhddos template canonical ReadWritePaths" grep -q "^ReadWritePaths=/opt/cybercorps /opt/cybercorps/bin /var/log /tmp" services/mhddos.service
check "distress template canonical ReadWritePaths" grep -q "^ReadWritePaths=/opt/cybercorps /opt/cybercorps/bin /var/log /tmp" services/distress.service
...
check "mhddos regenerate canonical ReadWritePaths" grep -q 'ReadWritePaths=${SCRIPT_DIR} ${SCRIPT_DIR}/bin /var/log /tmp' utils/mhddos.sh
